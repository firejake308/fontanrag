        ...
        arrhythmia_messages.append([
            {
                ...
                + f"\n\nInclude only personal history and not family history. A few tips: Atrial arrythmias include atrial fibrillation, atrial flutter, and also supraventricular tachycardia (SVT), intraatrial reentrant tachycardia (IART), AVNRT, or sinus bradycardia. If you are not sure whether a ventricular tachycardia was sustained or non-sustained, apply the heuristic that defibrillation is most often used for sustained V-tach. AV blocks and junctional rhythms do not count as either atrial or ventricular arrhythmias.\n\nHere is the note:\n---\n{truncated_text}\n---\nNow that you have read the note, decide whether or not the note explicitly states that the patient has, or has ever had, each arrhythmia. Answer in the form of a JSON dictionary of the form\n" + 
'''{
